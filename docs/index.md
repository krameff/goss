...
- [The gossfile](gossfile.md) — full resource and matcher reference, including [discovery](gossfile.md#discovery) and [test dependencies (`depends-on`)](gossfile.md#test-dependencies)
